...
const byte EVGA = 2;  // Encoder vérin gauche A
const byte EVGB = 52; // Encoder vérin gauche B
const byte EVDA = 3;  // Encoder vérin droit A
const byte EVDB = 4;  // Encoder vérin droit B

/*--- ENCODEURS AUX ROUES ---*/
const byte ERGA = 19; // Encoder roue gauche A
const byte ERGB = 15; // Encoder roue gauche B
const byte ERDA = 18; // Encoder roue droite A
const byte ERDB = 14; // Encoder roue droite B
...
/*--- Poignées ---*/
const byte potg = A12; // Potentiomètre de la gachette de la poignée côté batterie
const byte potd = A11; // Potentiomètre de la gachette de la poignée côté contrôleur
...
Encoder EncodeurRoueGauche(ERGA, ERGB); // Object pour l'encodeur de la roue gauche
Encoder EncodeurRoueDroite(ERDA, ERDB); // Object pour l'encodeur de la roue droite
...
NexNumber Heure = NexNumber(0, 49, "Heure");                   // Nombre qui indique l'heure
NexNumber Minute = NexNumber(0, 51, "Minute");                 // Nombre qui indique les minutes
...
NexText TxtPoids = NexText(0, 19, "TxtPoids");                 // Texte qui indique le poids de l'utilisateur
...
NexPicture pAcc = NexPicture(3, 3, "pAcc");              // Image pour régler l'acceleration du Zénith
NexPicture pDev = NexPicture(3, 2, "pDev");              // Image pour régler la déviation du Zénith
...
NexButton HeurePlus = NexButton(3, 23, "HeurePlus");     // Bouton pour augmenter l'heure
NexButton HeureMoins = NexButton(3, 24, "HeureMoins");   // Bouton pour diminuer l'heure
NexButton MinutePlus = NexButton(3, 26, "MinutePlus");   // Bouton pour augmenter les minutes
NexButton MinuteMoins = NexButton(3, 27, "MinuteMoins"); // Bouton pour diminuer les minutes
...
NexNumber HeureP3 = NexNumber(3, 21, "HeureP3");         // Nombre qui indique l'heure
NexNumber MinuteP3 = NexNumber(3, 23, "MinuteP3");       // Nombre qui indique les minutes
NexText TxtReg = NexText(3, 8, "TxtReg");                // Texte "Réglages"
NexText TxtDev = NexText(3, 6, "TxtDev");                // Texte "Déviation"
NexText TxtAcc = NexText(3, 7, "TxtAcc");                // Texte "Accélération"
NexText TxtHor = NexText(3, 28, "TxtHor");               // Texte "Horloge"
NexText TxtGauche = NexText(3, 16, "TxtGauche");         // Texte "Gauche"
NexText TxtDroite = NexText(3, 17, "TxtDroite");         // Texte "Droite"
NexText TxtLent = NexText(3, 14, "TxtLent");             // Texte "Lent"
NexText TxtRapide = NexText(3, 15, "TxtRapide");         // Texte "Rapide"
NexText TxtMan = NexText(3, 11, "TxtMan");               // Texte "Voir manuel d'utilisation"
NexText TxtLangue = NexText(3, 31, "TxtLangue");         // Texte "Langue"
